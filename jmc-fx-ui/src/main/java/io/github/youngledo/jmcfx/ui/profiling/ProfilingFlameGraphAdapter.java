...
import io.github.youngledo.jmcfx.flamegraph.FlameGraphNode;
import io.github.youngledo.jmcfx.flamegraph.FlameGraphRenderContext;
import io.github.youngledo.jmcfx.flamegraph.FrameColorProvider;
import io.github.youngledo.jmcfx.flamegraph.FrameTextProvider;
import io.github.youngledo.jmcfx.flamegraph.FrameTooltipProvider;
...
public final class ProfilingFlameGraphAdapter {
    ...
    private static int methodSeed(io.github.youngledo.jmcfx.flamegraph.FlameGraphFrame<StackFrameInfo> frame) {
        if (frame == null) {
            return 0;
        }
        StackFrameInfo info = frame.node().payload();
