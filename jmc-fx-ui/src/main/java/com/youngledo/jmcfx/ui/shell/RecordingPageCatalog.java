...
final class RecordingPageCatalog {
    ...
    private static final List<RecordingPageDescriptor> PAGES = List.of(
            ...
            page("nativeLibraries", "javaApplication", "nav.nativeLibraries", RecordingPageTemplate.DATA_TABLE, 0.50),
            page("threadDumps", "javaApplication", "nav.threadDumps", RecordingPageTemplate.SPLIT_TABLE_DETAIL, 0.38),
            page("heap", "memoryAnalysis", "nav.heap", RecordingPageTemplate.SPLIT_TABLE_DETAIL, 0.38),
            page("leaks", "memoryAnalysis", "nav.leaks", RecordingPageTemplate.SPLIT_TABLE_DETAIL, 0.38),
            page("tlab", "memoryAnalysis", "nav.tlab", RecordingPageTemplate.SPLIT_TABLE_DETAIL, 0.38),
