...
class FakeJvmServicesTest {
    ...
    private static io.github.youngledo.jmcfx.domain.model.RecordingSummary recording() {
        return new io.github.youngledo.jmcfx.domain.model.RecordingSummary("rec",
