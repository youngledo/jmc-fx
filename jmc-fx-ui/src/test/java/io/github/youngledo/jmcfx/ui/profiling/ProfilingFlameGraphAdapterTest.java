...
import io.github.youngledo.jmcfx.flamegraph.FlameGraphFrameColors;
import io.github.youngledo.jmcfx.flamegraph.FlameGraphFrameState;
import io.github.youngledo.jmcfx.flamegraph.FlameGraphMode;
import io.github.youngledo.jmcfx.flamegraph.FlameGraphModel;
import io.github.youngledo.jmcfx.flamegraph.FlameGraphRenderContext;
...
class ProfilingFlameGraphAdapterTest {
    ...
    void tooltipIncludesPackageClassWeightTypeByteCodeIndexAndLine() {
        StackFrameInfo info = frameInfo();
        io.github.youngledo.jmcfx.flamegraph.FlameGraphFrame<StackFrameInfo> frame =
    ...
    void colorProviderUsesMethodStableMulticolorPalette() {
        ...
        io.github.youngledo.jmcfx.flamegraph.FlameGraphFrame<StackFrameInfo> workerFrame =
                frame("com.example.Worker.run()", 42, 12.5, workerInfo, 1, List.of(0));
        io.github.youngledo.jmcfx.flamegraph.FlameGraphFrame<StackFrameInfo> sameWorkerElsewhere =
                frame("com.example.Worker.run()", 24, 8.5, workerInfo, 4, List.of(0, 1, 2, 3));
        io.github.youngledo.jmcfx.flamegraph.FlameGraphFrame<StackFrameInfo> parserFrame =
    ...
    private io.github.youngledo.jmcfx.flamegraph.FlameGraphFrame<StackFrameInfo> frame(
            String label,
            double weight,
            double percentage,
            StackFrameInfo info) {
    ...
    private io.github.youngledo.jmcfx.flamegraph.FlameGraphFrame<StackFrameInfo> frame(
            ...
            int depth,
            List<Integer> path) {
        return new io.github.youngledo.jmcfx.flamegraph.FlameGraphFrame<>(
                new io.github.youngledo.jmcfx.flamegraph.FlameGraphNode<>(
                        label,
                        weight,
                        percentage,
                        info,
