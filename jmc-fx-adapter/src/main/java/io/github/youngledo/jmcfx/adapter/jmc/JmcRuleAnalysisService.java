...
public class JmcRuleAnalysisService implements RuleAnalysisService {
	...
	static io.github.youngledo.jmcfx.domain.model.Severity mapSeverity(Severity jmcSeverity) {
		if (jmcSeverity == null) {
			return io.github.youngledo.jmcfx.domain.model.Severity.UNKNOWN;
		}
		return switch (jmcSeverity) {
			case OK -> io.github.youngledo.jmcfx.domain.model.Severity.OK;
			case INFO -> io.github.youngledo.jmcfx.domain.model.Severity.INFO;
			case WARNING -> io.github.youngledo.jmcfx.domain.model.Severity.WARNING;
			case NA -> io.github.youngledo.jmcfx.domain.model.Severity.UNAVAILABLE;
			case IGNORE -> io.github.youngledo.jmcfx.domain.model.Severity.IGNORED;
		};
	}
