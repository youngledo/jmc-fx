...
public class JmcMBeanBrowserService implements MBeanBrowserService {
    ...
    @Override
    public List<com.youngledo.jmcfx.domain.model.MBeanAttributeInfo> attributes(
    ...
    @Override
    public List<com.youngledo.jmcfx.domain.model.MBeanOperationInfo> operations(
            JvmConnection connection, String objectName) {
        try {
    ...
    private com.youngledo.jmcfx.domain.model.MBeanAttributeInfo attributeInfo(
        ...
        return new com.youngledo.jmcfx.domain.model.MBeanAttributeInfo(
                attribute.getName(),
                attribute.getType(),
    ...
    private com.youngledo.jmcfx.domain.model.MBeanOperationInfo operationInfo(MBeanOperationInfo operation) {
        List<MBeanOperationParameter> parameters = Arrays.stream(operation.getSignature())
                ...
                .toList();
        return new com.youngledo.jmcfx.domain.model.MBeanOperationInfo(
                operation.getName(),
